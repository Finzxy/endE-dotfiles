...
-- SOURCE
dofile(os.getenv("HOME") .. "/.config/hypr/Modules/colors.lua")
...
hl.on("hyprland.start", function () 
  hl.exec_cmd("waybar & awww-daemon, quickshell")
end)
...
hl.bind("Print", hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | tee ~/Pictures/screenshot-$(date +%F_%T).png | wl-copy --type image/png"))
